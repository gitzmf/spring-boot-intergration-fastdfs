...
public class FastDFSClientDemo{
    private static final String CONFIG_FILENAME = "E:\\IDEA\\ideaWorkspace\\spring-boot-intergration-fastdfs\\src\\main\\resources\\fdfs_client.conf";
    ...
    public FastDFSClientDemo() throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        FastDFSClientDemo client = new FastDFSClientDemo();
        File file = new File("F:\\home_top_bg.jpg");
